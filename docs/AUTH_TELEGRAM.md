...
- `MAX_AUTH_FUTURE_SKEW_SECONDS = 60s` — защита от initData “из будущего” (anti-replay)
...
- Предпочитайте короткие машинные коды (`INVALID_REQUEST`, `UNAUTHORIZED`, `AUTH_NOT_CONFIGURED`),
  а не детали внутренней валидации.
