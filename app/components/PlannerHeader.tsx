...
export default function PlannerHeader({
  ...
  return (
    <header className="relative z-30 flex flex-col glass rounded-b-[36px] shadow-sm transition-all">
      <div className="pl-[max(1.25rem,var(--tg-content-safe-area-inset-left,0px),var(--tg-safe-area-inset-left,0px),var(--tg-content-safe-left,0px),env(safe-area-inset-left))] pr-[max(1.25rem,var(--tg-content-safe-area-inset-right,0px),var(--tg-safe-area-inset-right,0px),var(--tg-content-safe-right,0px),env(safe-area-inset-right))] pt-[calc(max(var(--tg-content-safe-area-inset-top,0px),var(--tg-safe-area-inset-top,0px),var(--tg-content-safe-top,0px),var(--tg-safe-top,0px),env(safe-area-inset-top))+1rem)] pb-2">
