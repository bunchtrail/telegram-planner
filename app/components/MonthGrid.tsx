				...
				{days.map((day) => {
					...
					return (
						<button
							...
							className={cn(
								'relative flex h-10 w-full flex-col items-center justify-center rounded-[12px] text-[14px] transition-[transform,opacity] duration-200 active:scale-95 touch-manipulation',
								isSelected
